#ifndef HALIDE__gaussian_lib_h
#define HALIDE__gaussian_lib_h
#include <stdint.h>
...
int gaussian(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS;
int gaussian_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *gaussian_metadata() HALIDE_FUNCTION_ATTRS;
