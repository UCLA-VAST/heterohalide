...
def _all(input_0, input_1, input_2, ):
    ...
    gray_0 = hcl.compute(((output_2_extent_1 + 8), (output_2_extent_0 + 8), ), lambda gray_s0_y, gray_s0_x, : gray_0(gray_s0_y, gray_s0_x, input_0, input_1, input_2, ), name = "gray_0", dtype = hcl.UInt(bits = 8))

    def sum_x_0(sum_x_s0_y, sum_x_s0_x, input_0, input_1, input_2, ):
        return hcl.cast(dtype = hcl.UInt(bits = 32), expr = 0)
    sum_x_0 = hcl.compute((output_2_extent_1, output_2_extent_0, ), lambda sum_x_s0_y, sum_x_s0_x, : sum_x_0(sum_x_s0_y, sum_x_s0_x, input_0, input_1, input_2, ), name = "sum_x_0", dtype = hcl.UInt(bits = 32))
    ...
    sum_x_1 = hcl.compute((output_2_extent_1, output_2_extent_0, ), lambda sum_x_s1_y, sum_x_s1_x, : sum_x_1(sum_x_s1_y, sum_x_s1_x, input_0, input_1, input_2, sum_x_0, gray_0, ), name = "sum_x_1", dtype = hcl.UInt(bits = 32))
    ...
    blur_x_0 = hcl.compute((output_2_extent_1, output_2_extent_0, ), lambda blur_x_s0_y, blur_x_s0_x, : blur_x_0(blur_x_s0_y, blur_x_s0_x, input_0, input_1, input_2, sum_x_1, ), name = "blur_x_0", dtype = hcl.UInt(bits = 8))
    ...
    sharpen_0 = hcl.compute((output_2_extent_1, output_2_extent_0, ), lambda sharpen_s0_y, sharpen_s0_x, : sharpen_0(sharpen_s0_y, sharpen_s0_x, input_0, input_1, input_2, blur_x_0, gray_0, ), name = "sharpen_0", dtype = hcl.UInt(bits = 8))
    ...
    ratio_0 = hcl.compute((output_2_extent_1, output_2_extent_0, ), lambda ratio_s0_y, ratio_s0_x, : ratio_0(ratio_s0_y, ratio_s0_x, input_0, input_1, input_2, sharpen_0, gray_0, ), name = "ratio_0", dtype = hcl.UInt(bits = 8))
...
np.save("output_heterocl_2.npy", np_out)
