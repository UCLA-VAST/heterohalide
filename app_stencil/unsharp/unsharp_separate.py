...
hcl.init()
output_0_extent_0 = 2440
output_0_extent_1 = 3256
output_1_extent_0 = 2440
output_1_extent_1 = 3256
output_2_extent_0 = 2440
output_2_extent_1 = 3256
output_0_min_0 = 0
output_0_min_1 = 0
output_1_min_0 = 0
output_1_min_1 = 0
...
def _all(input_0, input_1, input_2, output_0, output_1, output_2):
    ...
    gray_0 = hcl.compute(((output_0_extent_1 + 8), (output_0_extent_0 + 8), ), lambda gray_s0_y, gray_s0_x, : gray_0(gray_s0_y, gray_s0_x, input_0, input_1, input_2, ), name = "gray_0", dtype = hcl.UInt(bits = 8))

    def sum_x_0(sum_x_s0_y, sum_x_s0_x, input_0, input_1, input_2, ):
        return hcl.cast(dtype = hcl.UInt(bits = 32), expr = 0)
    sum_x_0 = hcl.compute((output_0_extent_1, output_0_extent_0, ), lambda sum_x_s0_y, sum_x_s0_x, : sum_x_0(sum_x_s0_y, sum_x_s0_x, input_0, input_1, input_2, ), name = "sum_x_0", dtype = hcl.UInt(bits = 32))
    ...
    sum_x_1 = hcl.compute((output_0_extent_1, output_0_extent_0, ), lambda sum_x_s1_y, sum_x_s1_x, : sum_x_1(sum_x_s1_y, sum_x_s1_x, input_0, input_1, input_2, sum_x_0, gray_0, ), name = "sum_x_1", dtype = hcl.UInt(bits = 32))
    ...
    blur_x_0 = hcl.compute((output_0_extent_1, output_0_extent_0, ), lambda blur_x_s0_y, blur_x_s0_x, : blur_x_0(blur_x_s0_y, blur_x_s0_x, input_0, input_1, input_2, sum_x_1, ), name = "blur_x_0", dtype = hcl.UInt(bits = 8))
    ...
    sharpen_0 = hcl.compute((output_0_extent_1, output_0_extent_0, ), lambda sharpen_s0_y, sharpen_s0_x, : sharpen_0(sharpen_s0_y, sharpen_s0_x, input_0, input_1, input_2, blur_x_0, gray_0, ), name = "sharpen_0", dtype = hcl.UInt(bits = 8))
    ...
    ratio_0 = hcl.compute((output_0_extent_1, output_0_extent_0, ), lambda ratio_s0_y, ratio_s0_x, : ratio_0(ratio_s0_y, ratio_s0_x, input_0, input_1, input_2, sharpen_0, gray_0, ), name = "ratio_0", dtype = hcl.UInt(bits = 8))

    def hw_output_0_0(hw_output_0_s0_y, hw_output_0_s0_x, input_0, input_1, input_2, ratio, ):
        return hcl.cast(dtype = hcl.UInt(bits = 8), expr = hcl.select(((hcl.cast(dtype = hcl.UInt(bits = 16), expr = ratio[hw_output_0_s0_y, hw_output_0_s0_x]) * hcl.cast(dtype = hcl.UInt(bits = 16), expr = input_0[(hw_output_0_s0_y + 4), (hw_output_0_s0_x + 4)]))/hcl.cast(dtype = hcl.UInt(bits = 16), expr = 32)) < hcl.cast(dtype = hcl.UInt(bits = 16), expr = 255), ((hcl.cast(dtype = hcl.UInt(bits = 16), expr = ratio[hw_output_0_s0_y, hw_output_0_s0_x]) * hcl.cast(dtype = hcl.UInt(bits = 16), expr = input_0[(hw_output_0_s0_y + 4), (hw_output_0_s0_x + 4)]))/hcl.cast(dtype = hcl.UInt(bits = 16), expr = 32)), hcl.cast(dtype = hcl.UInt(bits = 16), expr = 255)))
    hw_output_0_0 = hcl.compute((output_0_extent_1, output_0_extent_0, ), lambda hw_output_0_s0_y, hw_output_0_s0_x, : hw_output_0_0(hw_output_0_s0_y, hw_output_0_s0_x, input_0, input_1, input_2, ratio_0, ), name = "hw_output_0_0", dtype = hcl.UInt(bits = 8))

    def output_0_0(output_0_s0_y, output_0_s0_x, input_0, input_1, input_2, hw_output_0, ):
        return hw_output_0[output_0_s0_y, output_0_s0_x]
    output_0_0 = hcl.compute((output_0_extent_1, output_0_extent_0, ), lambda output_0_s0_y, output_0_s0_x, : output_0_0(output_0_s0_y, output_0_s0_x, input_0, input_1, input_2, hw_output_0_0, ), name = "output_0_0", dtype = hcl.UInt(bits = 8))

    hcl.update(output_0, lambda y, x: output_0_0[y, x])
    ...
    hcl.update(output_1, lambda y, x: output_1_0[y, x])

    def hw_output_2_0(hw_output_2_s0_y, hw_output_2_s0_x, input_0, input_1, input_2, ratio, ):
        return hcl.cast(dtype = hcl.UInt(bits = 8), expr = hcl.select(((hcl.cast(dtype = hcl.UInt(bits = 16), expr = ratio[hw_output_2_s0_y, hw_output_2_s0_x]) * hcl.cast(dtype = hcl.UInt(bits = 16), expr = input_2[(hw_output_2_s0_y + 4), (hw_output_2_s0_x + 4)]))/hcl.cast(dtype = hcl.UInt(bits = 16), expr = 32)) < hcl.cast(dtype = hcl.UInt(bits = 16), expr = 255), ((hcl.cast(dtype = hcl.UInt(bits = 16), expr = ratio[hw_output_2_s0_y, hw_output_2_s0_x]) * hcl.cast(dtype = hcl.UInt(bits = 16), expr = input_2[(hw_output_2_s0_y + 4), (hw_output_2_s0_x + 4)]))/hcl.cast(dtype = hcl.UInt(bits = 16), expr = 32)), hcl.cast(dtype = hcl.UInt(bits = 16), expr = 255)))
    hw_output_2_0 = hcl.compute((output_2_extent_1, output_2_extent_0, ), lambda hw_output_2_s0_y, hw_output_2_s0_x, : hw_output_2_0(hw_output_2_s0_y, hw_output_2_s0_x, input_0, input_1, input_2, ratio_0, ), name = "hw_output_2_0", dtype = hcl.UInt(bits = 8))

    def output_2_0(output_2_s0_y, output_2_s0_x, input_0, input_1, input_2, hw_output_2, ):
        return hw_output_2[output_2_s0_y, output_2_s0_x]
    output_2_0 = hcl.compute((output_2_extent_1, output_2_extent_0, ), lambda output_2_s0_y, output_2_s0_x, : output_2_0(output_2_s0_y, output_2_s0_x, input_0, input_1, input_2, hw_output_2_0, ), name = "output_2_0", dtype = hcl.UInt(bits = 8))

    hcl.update(output_2, lambda y, x: output_2_0[y, x])

    return 

input_0 = hcl.placeholder((2448, 3264, ), name = "input_0", dtype = hcl.UInt(bits = 8))
input_1 = hcl.placeholder((2448, 3264, ), name = "input_1", dtype = hcl.UInt(bits = 8))
input_2 = hcl.placeholder((2448, 3264, ), name = "input_2", dtype = hcl.UInt(bits = 8))
output_0 = hcl.placeholder((2440, 3256), name = "output_0", dtype = hcl.UInt(bits = 8))
output_1 = hcl.placeholder((2440, 3256), name = "output_1", dtype = hcl.UInt(bits = 8))
output_2 = hcl.placeholder((2440, 3256), name = "output_2", dtype = hcl.UInt(bits = 8))

s = hcl.create_schedule([input_0, input_1, input_2, output_0, output_1, output_2], _all)
f = hcl.build(s)
print(hcl.lower(s))
# import numpy as np
...
# np.save("output_heterocl_0.npy", np_out)
