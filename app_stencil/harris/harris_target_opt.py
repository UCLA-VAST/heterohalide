...
def _all(input, ):
    ...
    def grad_gx_1(grad_gx_s1_y, grad_gx_s1_x, input, grad_xx, ):
    ...
    grad_gx_1 = hcl.compute(((output_extent_1 + 2), (output_extent_0 + 2), ), lambda grad_gx_s1_y, grad_gx_s1_x, : grad_gx_1(grad_gx_s1_y, grad_gx_s1_x, input, grad_xx_0, ), name = "grad_gx_1", dtype = hcl.Int(bits = 32))
    ...
    def grad_gxy_1(grad_gxy_s1_y, grad_gxy_s1_x, input, grad_xy, ):
        _sum = hcl.reducer(0, lambda x, y: x + y)
    ...
    grad_gxy_1 = hcl.compute(((output_extent_1 + 2), (output_extent_0 + 2), ), lambda grad_gxy_s1_y, grad_gxy_s1_x, : grad_gxy_1(grad_gxy_s1_y, grad_gxy_s1_x, input, grad_xy_0, ), name = "grad_gxy_1", dtype = hcl.Int(bits = 32))
    ...
    def grad_gy_1(grad_gy_s1_y, grad_gy_s1_x, input, grad_yy, ):
        _sum = hcl.reducer(0, lambda x, y: x + y)
    ...
    grad_gy_1 = hcl.compute(((output_extent_1 + 2), (output_extent_0 + 2), ), lambda grad_gy_s1_y, grad_gy_s1_x, : grad_gy_1(grad_gy_s1_y, grad_gy_s1_x, input,  grad_yy_0, ), name = "grad_gy_1", dtype = hcl.Int(bits = 32))
...
np.save("output_heterocl_new_new_optimize.npy", np_out)
