...
def _all(input, ):
    ...
    def cim_0(cim_s0_y, cim_s0_x, input, grad_gy, grad_gxy, grad_gx, ):
        t49 = grad_gx[cim_s0_y, cim_s0_x]
        t50 = grad_gy[cim_s0_y, cim_s0_x]
        t51 = grad_gxy[cim_s0_y, cim_s0_x]
        ...
        return hcl.cast(dtype = hcl.Float(bits = 32), expr = (t51/144))
        # return hcl.cast(dtype = hcl.Float(bits = 32), expr = (t49/144)) * hcl.cast(dtype = hcl.Float(bits = 32), expr = (t50/144)) - (hcl.cast(dtype = hcl.Float(bits = 32), expr = (t51/144)) * hcl.cast(dtype = hcl.Float(bits = 32), expr = (t51/144)))
...
np.save("lgxy_heterocl.npy", np_out)
...
# cim_heterocl = np.load("cim_heterocl.npy")
# print(np.array_equal(cim_halide, cim_heterocl))
# print(dif(cim_halide, cim_heterocl))
