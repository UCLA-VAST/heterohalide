...
np.savetxt('/curr/jiajieli/app_halide2heterocl/conv/input.txt', input_flat, fmt = '%d')
np.savetxt('/curr/jiajieli/app_halide2heterocl/conv/filter.txt', filter_flat, fmt = '%d')
np.savetxt('/curr/jiajieli/app_halide2heterocl/conv/bias.txt', bias, fmt = '%d')