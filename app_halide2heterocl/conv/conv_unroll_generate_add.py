...
def _all(_input, _filter, _bias, ):
    ...
    def _f_conv_1(_f_conv_s1_n, _f_conv_s1_z, _f_conv_s1_y, _f_conv_s1_x, _input, _filter, _bias, _f_conv, ):
        ...
        out[0] = (_f_conv[_f_conv_s1_y, _f_conv_s1_x, _f_conv_s1_z, _f_conv_s1_n] + _sum(
    ...
    def _f_relu_0(_f_relu_s0_x, _f_relu_s0_y, _f_relu_s0_n, _f_relu_s0_z, _input, _filter, _bias, _f_conv, ):
        out = hcl.local(0)
        out[0] = hcl.select(_f_conv[_f_relu_s0_n, _f_relu_s0_z, _f_relu_s0_y, _f_relu_s0_x] > float(0.000000), _f_conv[_f_relu_s0_n, _f_relu_s0_z, _f_relu_s0_y, _f_relu_s0_x], float(0.000000))
        return out[0]
