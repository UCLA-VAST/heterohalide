...
def _all(input, output_0):
    ...
    def output_0_f(output_s0_c, output_s0_y, output_s0_x, input, srgb, ):
    ...
    # output_0 = hcl.update((output_extent_2, output_extent_1, output_extent_0, ), lambda output_s0_c, output_s0_y, output_s0_x, : output_0(output_s0_c, output_s0_y, output_s0_x, input, srgb_0, ), name = "output_0", dtype = hcl.Float(bits = 32))
    hcl.update(output_0, lambda output_s0_c, output_s0_y, output_s0_x, : output_0_f(output_s0_c, output_s0_y, output_s0_x, input, srgb_0 ), name = "output_0")
    # return output_0
    return
input = hcl.placeholder((3, 1280, 768, ), name = "input", dtype = hcl.Float(bits = 32))
output_0 = hcl.placeholder((3, 1278, 766), name = "output_0", dtype = hcl.Float(bits = 32))
s = hcl.create_schedule([input, output_0], _all)
# fuse
# s_linear_0 = _all.linear_0
# s[s_linear_0].fuse(s_linear_0.axis[0], s_linear_0.axis[1])
# s_blur_x_0 = _all.blur_x_0
# s[s_blur_x_0].fuse(s_blur_x_0.axis[0], s_blur_x_0.axis[1])
# s_blur_y_0 = _all.blur_y_0
# s[s_blur_y_0].fuse(s_blur_y_0.axis[0], s_blur_y_0.axis[1])
# s_srgb_0 = _all.srgb_0
# s[s_srgb_0].fuse(s_srgb_0.axis[0], s_srgb_0.axis[1])
# s_output_0 = _all.output_0
# s[s_output_0].fuse(s_output_0.axis[0], s_output_0.axis[1])
f = hcl.build(s)
print(hcl.lower(s))
import numpy as np
