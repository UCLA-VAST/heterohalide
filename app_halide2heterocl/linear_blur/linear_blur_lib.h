#ifndef HALIDE__linear_blur_lib_h
#define HALIDE__linear_blur_lib_h
#include <stdint.h>
...
int linear_blur(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_srgb_buffer) HALIDE_FUNCTION_ATTRS;
int linear_blur_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *linear_blur_metadata() HALIDE_FUNCTION_ATTRS;
