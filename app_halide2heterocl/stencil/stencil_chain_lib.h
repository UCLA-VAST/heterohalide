#ifndef HALIDE__stencil_chain_lib_h
#define HALIDE__stencil_chain_lib_h
#include <stdint.h>
...
int stencil_chain(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS;
int stencil_chain_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *stencil_chain_metadata() HALIDE_FUNCTION_ATTRS;
