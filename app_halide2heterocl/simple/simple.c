...
int simple(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS {
 ...
 int32_t _10 = _halide_buffer_get_dimensions(_input_buffer);
 int32_t _11 = _halide_buffer_get_min(_input_buffer, 0);
 int32_t _12 = _halide_buffer_get_extent(_input_buffer, 0);
 int32_t _13 = _halide_buffer_get_stride(_input_buffer, 0);
 int32_t _14 = _halide_buffer_get_min(_input_buffer, 1);
 int32_t _15 = _halide_buffer_get_extent(_input_buffer, 1);
 int32_t _16 = _halide_buffer_get_stride(_input_buffer, 1);
 void *_17 = _halide_buffer_get_host(_output_buffer);
 void * _output = _17;
 uint32_t _18 = _halide_buffer_get_type(_output_buffer);
 int32_t _19 = _halide_buffer_get_dimensions(_output_buffer);
 int32_t _20 = _halide_buffer_get_min(_output_buffer, 0);
 int32_t _21 = _halide_buffer_get_extent(_output_buffer, 0);
 int32_t _22 = _halide_buffer_get_stride(_output_buffer, 0);
 int32_t _23 = _halide_buffer_get_min(_output_buffer, 1);
 int32_t _24 = _halide_buffer_get_extent(_output_buffer, 1);
 int32_t _25 = _halide_buffer_get_stride(_output_buffer, 1);
 ...
 if (!_32)  {
  int32_t _33 = _21 + _20;
  int32_t _34 = _33 + -1;
  int32_t _35 = halide_error_constraints_make_required_region_smaller(_ucon, "Input buffer input", 0, 0, 7, _20, _34);
  return _35;
 }
 ...
 if (!_42)  {
  int32_t _43 = _24 + _23;
  int32_t _44 = _43 + -1;
  int32_t _45 = halide_error_constraints_make_required_region_smaller(_ucon, "Input buffer input", 1, 0, 7, _23, _44);
  return _45;
 }
 bool _46 = _halide_buffer_is_bounds_query(_input_buffer);
 if (_46)
 {
  struct halide_dimension_t *_47 = _halide_buffer_get_shape(_input_buffer);
  ...
  struct halide_buffer_t *_52 = _halide_buffer_init(_input_buffer, _47, _49, _48, _50, 0, 32, 2, _51, _48);
  (void)_52;
 } // if _46
 bool _53 = _halide_buffer_is_bounds_query(_output_buffer);
 if (_53)
 {
  struct halide_dimension_t *_54 = _halide_buffer_get_shape(_output_buffer);
  ...
  struct halide_buffer_t *_59 = _halide_buffer_init(_output_buffer, _54, _56, _55, _57, 0, 32, 2, _58, _55);
  (void)_59;
 } // if _53
 bool _60 = _halide_buffer_is_bounds_query(_input_buffer);
 bool _61 = _halide_buffer_is_bounds_query(_output_buffer);
 bool _62 = _60 || _61;
 bool _63 = !(_62);
 if (_63)
 {
  uint32_t _64 = (uint32_t)(73728);
  bool _65 = _9 == _64;
  if (!_65)   {
   uint32_t _66 = (uint32_t)(73728);
   int32_t _67 = halide_error_bad_type(_ucon, "Input buffer input", _9, _66);
   return _67;
  }
  bool _68 = _10 == 2;
  if (!_68)   {
   int32_t _69 = halide_error_bad_dimensions(_ucon, "Input buffer input", _10, 2);
   return _69;
  }
  uint32_t _70 = (uint32_t)(73728);
  bool _71 = _18 == _70;
  if (!_71)   {
   uint32_t _72 = (uint32_t)(73728);
   int32_t _73 = halide_error_bad_type(_ucon, "Output buffer output", _18, _72);
   return _73;
  }
  bool _74 = _19 == 2;
  if (!_74)   {
   int32_t _75 = halide_error_bad_dimensions(_ucon, "Output buffer output", _19, 2);
   return _75;
  }
  bool _76 = _11 <= _20;
  int32_t _77 = _21 + _20;
  ...
  if (!_80)   {
   ...
   int32_t _83 = _12 + _11;
   int32_t _84 = _83 + -1;
   int32_t _85 = halide_error_access_out_of_bounds(_ucon, "Input buffer input", 0, _20, _82, _11, _84);
   return _85;
  }
  bool _86 = 0 <= _12;
  if (!_86)   {
   int32_t _87 = halide_error_buffer_extents_negative(_ucon, "Input buffer input", 0, _12);
   return _87;
  }
  bool _88 = _14 <= _23;
  int32_t _89 = _24 + _23;
  ...
  if (!_92)   {
   ...
   int32_t _95 = _15 + _14;
   int32_t _96 = _95 + -1;
   int32_t _97 = halide_error_access_out_of_bounds(_ucon, "Input buffer input", 1, _23, _94, _14, _96);
   return _97;
  }
  bool _98 = 0 <= _15;
  if (!_98)   {
   int32_t _99 = halide_error_buffer_extents_negative(_ucon, "Input buffer input", 1, _15);
   return _99;
  }
  bool _100 = 0 <= _21;
  if (!_100)   {
   int32_t _101 = halide_error_buffer_extents_negative(_ucon, "Output buffer output", 0, _21);
   return _101;
  }
  bool _102 = 0 <= _24;
  if (!_102)   {
   int32_t _103 = halide_error_buffer_extents_negative(_ucon, "Output buffer output", 1, _24);
   return _103;
  }
  bool _104 = _13 == 1;
  if (!_104)   {
   int32_t _105 = halide_error_constraint_violated(_ucon, "input.stride.0", _13, "1", 1);
   return _105;
  }
  bool _106 = _11 == 0;
  if (!_106)   {
   int32_t _107 = halide_error_constraint_violated(_ucon, "input.min.0", _11, "0", 0);
   return _107;
  }
  bool _108 = _12 == 8;
  if (!_108)   {
   int32_t _109 = halide_error_constraint_violated(_ucon, "input.extent.0", _12, "8", 8);
   return _109;
  }
  bool _110 = _16 == 8;
  if (!_110)   {
   int32_t _111 = halide_error_constraint_violated(_ucon, "input.stride.1", _16, "8", 8);
   return _111;
  }
  bool _112 = _14 == 0;
  if (!_112)   {
   int32_t _113 = halide_error_constraint_violated(_ucon, "input.min.1", _14, "0", 0);
   return _113;
  }
  bool _114 = _15 == 8;
  if (!_114)   {
   int32_t _115 = halide_error_constraint_violated(_ucon, "input.extent.1", _15, "8", 8);
   return _115;
  }
  bool _116 = _22 == 1;
  if (!_116)   {
   int32_t _117 = halide_error_constraint_violated(_ucon, "output.stride.0", _22, "1", 1);
   return _117;
  }
  int64_t _118 = (int64_t)(_24);
  int64_t _119 = (int64_t)(_21);
  int64_t _120 = _118 * _119;
  int64_t _121 = (int64_t)(0);
  int64_t _122 = _121 - _119;
  bool _123 = _119 > _121;
  int64_t _124 = (int64_t)(_123 ? _119 : _122);
  uint64_t _125 = (uint64_t)(_124);
  uint64_t _126 = _125;
  uint64_t _127 = (uint64_t)(2147483647);
  bool _128 = _126 <= _127;
  if (!_128)   {
   int64_t _129 = (int64_t)(_21);
   int64_t _130 = (int64_t)(0);
   int64_t _131 = _130 - _129;
   bool _132 = _129 > _130;
   int64_t _133 = (int64_t)(_132 ? _129 : _131);
   uint64_t _134 = (uint64_t)(_133);
   uint64_t _135 = _134;
   uint64_t _136 = (uint64_t)(2147483647);
   int32_t _137 = halide_error_buffer_allocation_too_large(_ucon, "output", _135, _136);
   return _137;
  }
  int64_t _138 = (int64_t)(_24);
  int64_t _139 = (int64_t)(_25);
  ...
  bool _148 = _146 <= _147;
  if (!_148)   {
   int64_t _149 = (int64_t)(_24);
   int64_t _150 = (int64_t)(_25);
   ...
   int32_t _159 = halide_error_buffer_allocation_too_large(_ucon, "output", _157, _158);
   return _159;
  }
  ...
  if (!_161)   {
   ...
   int32_t _163 = halide_error_buffer_extents_too_large(_ucon, "output", _120, _162);
   return _163;
  }
  uint64_t _164 = (uint64_t)(0);
  void *_165 = (void *)(_164);
  bool _166 = _input != _165;
  if (!_166)   {
   int32_t _167 = halide_error_host_is_null(_ucon, "Input buffer input");
   return _167;
  }
  uint64_t _168 = (uint64_t)(0);
  void *_169 = (void *)(_168);
  bool _170 = _output != _169;
  if (!_170)   {
   int32_t _171 = halide_error_host_is_null(_ucon, "Output buffer output");
   return _171;
  }
  // produce output
  for (int _output_s0_y = _23; _output_s0_y < _23 + _24; _output_s0_y++)
  {
   for (int _output_s0_x = _20; _output_s0_x < _20 + _21; _output_s0_x++)
   {
    int32_t _172 = _output_s0_y * 8;
    int32_t _173 = _172 + _output_s0_x;
    int32_t _174 = ((const int32_t *)_input)[_173];
    int32_t _175 = _174 * 2;
    int32_t _176 = _output_s0_y * _25;
    int32_t _177 = _176 + _output_s0_x;
    int32_t _178 = _23 * _25;
    int32_t _179 = _178 + _20;
    int32_t _180 = _177 - _179;
    ((int32_t *)_output)[_180] = _175;
   } // for _output_s0_x
  } // for _output_s0_y
 } // if _63
 return 0;
