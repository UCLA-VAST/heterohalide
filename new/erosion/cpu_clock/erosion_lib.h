#ifndef HALIDE__erosion_lib_h
#define HALIDE__erosion_lib_h
#include <stdint.h>
...
int erosion(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_min_local_buffer) HALIDE_FUNCTION_ATTRS;
int erosion_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *erosion_metadata() HALIDE_FUNCTION_ATTRS;
