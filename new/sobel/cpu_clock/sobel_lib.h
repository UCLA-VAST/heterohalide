#ifndef HALIDE__sobel_lib_h
#define HALIDE__sobel_lib_h
#include <stdint.h>
...
int sobel(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_filter_x_buffer, struct halide_buffer_t *_filter_y_buffer, struct halide_buffer_t *_gy_buffer) HALIDE_FUNCTION_ATTRS;
