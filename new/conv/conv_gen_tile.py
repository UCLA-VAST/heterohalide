...
def top(input, filter, bias, ):
    ...
    f_conv = hcl.compute((hcl.select(final_extent_0 > 4, final_extent_0, 4), hcl.select(final_extent_1 > 4, final_extent_1, 4), final_extent_2, final_extent_3), lambda x, y, z, w: 0, name = "f_conv", dtype = hcl.Float(bits = 32))
    with hcl.Stage("f_conv"):
        with hcl.for_(final_min_3, final_extent_3, name = "f_conv_s0_n") as f_conv_s0_n:
            with hcl.for_(final_min_2, final_extent_2, name = "f_conv_s0_z") as f_conv_s0_z:
                with hcl.for_(0, ((final_extent_1 + 3)//4), name = "f_conv_s0_y_y") as f_conv_s0_y_y:
                    f_conv_s0_y_yi_base_s = hcl.select((f_conv_s0_y_y * 4) < (final_extent_1 + -4), (f_conv_s0_y_y * 4), (final_extent_1 + -4))
                    with hcl.for_(0, ((final_extent_0 + 3)//4), name = "f_conv_s0_x_x") as f_conv_s0_x_x:
                        f_conv_s0_x_xi_base_s = hcl.select((f_conv_s0_x_x * 4) < (final_extent_0 + -4), (f_conv_s0_x_x * 4), (final_extent_0 + -4))
                        with hcl.for_(0, 4, name = "f_conv_s0_y_yi") as f_conv_s0_y_yi:
                            with hcl.for_(0, 4, name = "f_conv_s0_x_xi") as f_conv_s0_x_xi:
                                f_conv[((f_conv_s0_x_xi_base_s + final_min_0) + f_conv_s0_x_xi), ((f_conv_s0_y_yi_base_s + final_min_1) + f_conv_s0_y_yi), f_conv_s0_z, f_conv_s0_n] = bias[f_conv_s0_z]
        ...
        with hcl.for_(final_min_3, final_extent_3, name = "f_conv_s1_n") as f_conv_s1_n:
            ...
            with hcl.for_(0, 32, name = "f_conv_s1_r__z") as f_conv_s1_r__z:
                ...
                with hcl.for_(0, ((final_extent_1 + 3)//4), name = "f_conv_s1_y_y") as f_conv_s1_y_y:
                    f_conv_s1_y_yi_base_s = hcl.select((f_conv_s1_y_y * 4) < (final_extent_1 + -4), (f_conv_s1_y_y * 4), (final_extent_1 + -4))
                    with hcl.for_(0, ((final_extent_0 + 3)//4), name = "f_conv_s1_x_x") as f_conv_s1_x_x:
                        f_conv_s1_x_xi_base_s = hcl.select((f_conv_s1_x_x * 4) < (final_extent_0 + -4), (f_conv_s1_x_x * 4), (final_extent_0 + -4))
                        with hcl.for_(0, 4, name = "f_conv_s1_y_yi") as f_conv_s1_y_yi:
                            with hcl.for_(0, 4, name = "f_conv_s1_x_xi") as f_conv_s1_x_xi:

                                with hcl.for_(final_min_2, final_extent_2, name = "f_conv_s1_z") as f_conv_s1_z:

                                    with hcl.for_(0, 3, name = "f_conv_s1_r__y") as f_conv_s1_r__y:
                                        with hcl.for_(0, 3, name = "f_conv_s1_r__x") as f_conv_s1_r__x:
                                            f_conv[((f_conv_s1_x_xi_base_s + final_min_0) + f_conv_s1_x_xi), ((f_conv_s1_y_yi_base_s + final_min_1) + f_conv_s1_y_yi), f_conv_s1_z, f_conv_s1_n] = (f_conv[((f_conv_s1_x_xi_base_s + final_min_0) + f_conv_s1_x_xi), ((f_conv_s1_y_yi_base_s + final_min_1) + f_conv_s1_y_yi), f_conv_s1_z, f_conv_s1_n] + (filter[f_conv_s1_r__x, f_conv_s1_r__y, f_conv_s1_r__z, f_conv_s1_z] * input[(f_conv_s1_r__x + ((f_conv_s1_x_xi_base_s + final_min_0) + f_conv_s1_x_xi)), (f_conv_s1_r__y + ((f_conv_s1_y_yi_base_s + final_min_1) + f_conv_s1_y_yi)), f_conv_s1_r__z, f_conv_s1_n]))
