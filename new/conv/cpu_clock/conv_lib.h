#ifndef HALIDE__conv_lib_h
#define HALIDE__conv_lib_h
#include <stdint.h>
...
int conv(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_filter_buffer, struct halide_buffer_t *_bias_buffer, struct halide_buffer_t *_final_buffer) HALIDE_FUNCTION_ATTRS;
int conv_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *conv_metadata() HALIDE_FUNCTION_ATTRS;
