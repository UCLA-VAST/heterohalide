...
def top(input, filter, bias, ):
    f_conv = hcl.compute((output_extent_0, output_extent_1, output_extent_2, output_extent_3), lambda x, y, z, w: 0, name = "f_conv", dtype = hcl.Float(bits = 32))
    with hcl.Stage("f_conv"):
        with hcl.for_(output_min_3, output_extent_3, name = "f_conv_s0_n") as f_conv_s0_n:
            with hcl.for_(output_min_2, output_extent_2, name = "f_conv_s0_z") as f_conv_s0_z:
        ...
        with hcl.for_(output_min_3, output_extent_3, name = "f_conv_s1_n") as f_conv_s1_n:
            with hcl.for_(output_min_2, output_extent_2, name = "f_conv_s1_z") as f_conv_s1_z:
    ...
    f_relu = hcl.compute((output_extent_0, output_extent_1, output_extent_2, output_extent_3), lambda x, y, z, w: 0, name = "f_relu", dtype = hcl.Float(bits = 32))
    with hcl.Stage("f_relu"):
        with hcl.for_(output_min_3, output_extent_3, name = "f_relu_s0_n") as f_relu_s0_n:
            with hcl.for_(output_min_2, output_extent_2, name = "f_relu_s0_z") as f_relu_s0_z:
    ...
    output = hcl.compute((64, 64, 32, 4), lambda x, y, z, w: 0, name = "output", dtype = hcl.Float(bits = 32))
    with hcl.Stage("output"):
        with hcl.for_(output_min_3, output_extent_3, name = "output_s0_n") as output_s0_n:
            with hcl.for_(output_min_2, output_extent_2, name = "output_s0_z") as output_s0_z:
                with hcl.for_(output_min_1, output_extent_1, name = "output_s0_y") as output_s0_y:
                    with hcl.for_(output_min_0, output_extent_0, name = "output_s0_x") as output_s0_x:
                        output[output_s0_x, output_s0_y, output_s0_z, output_s0_n] = f_relu[output_s0_x, output_s0_y, output_s0_z, output_s0_n]
    return output
