...
int main(int argc, char **argv) {
    ...
    final.compile_to_heterocl("dilation_generate.py", {input}, output_shape, "final"); // need some more modification to successfully run Code Generator, but it's doable
