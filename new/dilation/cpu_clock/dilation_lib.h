#ifndef HALIDE__dilation_lib_h
#define HALIDE__dilation_lib_h
#include <stdint.h>
...
int dilation(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_max_local_buffer) HALIDE_FUNCTION_ATTRS;
int dilation_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *dilation_metadata() HALIDE_FUNCTION_ATTRS;
