import numpy as np 
output_heterocl = np.load("/curr/jiajieli/new/median_blur/output_heterocl.npy")
print(output_heterocl.shape) # [w, h]
output_halide = np.loadtxt("/curr/jiajieli/new/median_blur/output_halide.txt")
...
input_heterocl = np.load("/curr/jiajieli/new/median_blur/input.npy")
input_halide = np.loadtxt("/curr/jiajieli/new/median_blur/input.txt")
