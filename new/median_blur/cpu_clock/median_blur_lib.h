#ifndef HALIDE__median_blur_lib_h
#define HALIDE__median_blur_lib_h
#include <stdint.h>
...
int median_blur(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_mean_local_buffer) HALIDE_FUNCTION_ATTRS;
int median_blur_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *median_blur_metadata() HALIDE_FUNCTION_ATTRS;
