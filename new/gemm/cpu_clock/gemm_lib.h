#ifndef HALIDE__gemm_lib_h
#define HALIDE__gemm_lib_h
#include <stdint.h>
...
int gemm(struct halide_buffer_t *_A_buffer, struct halide_buffer_t *_B_buffer, struct halide_buffer_t *_prod_buffer) HALIDE_FUNCTION_ATTRS;
int gemm_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *gemm_metadata() HALIDE_FUNCTION_ATTRS;
