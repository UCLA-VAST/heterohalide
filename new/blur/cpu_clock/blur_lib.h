#ifndef HALIDE__blur_lib_h
#define HALIDE__blur_lib_h
#include <stdint.h>
...
int blur_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *blur_metadata() HALIDE_FUNCTION_ATTRS;
