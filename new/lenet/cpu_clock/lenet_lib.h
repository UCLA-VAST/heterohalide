#ifndef HALIDE__lenet_lib_h
#define HALIDE__lenet_lib_h
#include <stdint.h>
...
int lenet(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_weight_conv1_buffer, struct halide_buffer_t *_weight_conv2_buffer, struct halide_buffer_t *_weight_fc1_buffer, struct halide_buffer_t *_weight_fc2_buffer, struct halide_buffer_t *_final_buffer) HALIDE_FUNCTION_ATTRS;
int lenet_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *lenet_metadata() HALIDE_FUNCTION_ATTRS;
