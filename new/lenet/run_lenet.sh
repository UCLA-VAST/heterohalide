...
g++ lenet.cpp -g -std=c++11 -I /curr/jiajieli/Halide/include -I /curr/jiajieli/Halide/tools -L /curr/jiajieli/Halide/bin -lHalide `libpng-config --cflags --ldflags` -ljpeg -lpthread -ldl -o lenet
LD_LIBRARY_PATH=/curr/jiajieli/Halide/bin /curr/jiajieli/new/lenet/lenet
