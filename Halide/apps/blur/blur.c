...
int blur(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_blur_y_buffer) HALIDE_FUNCTION_ATTRS {
 ...
 void *_8 = _halide_buffer_get_host(_blur_y_buffer);
 void * _blur_y = _8;
 uint32_t _9 = _halide_buffer_get_type(_blur_y_buffer);
 int32_t _10 = _halide_buffer_get_dimensions(_blur_y_buffer);
 int32_t _11 = _halide_buffer_get_min(_blur_y_buffer, 0);
 int32_t _12 = _halide_buffer_get_extent(_blur_y_buffer, 0);
 int32_t _13 = _halide_buffer_get_stride(_blur_y_buffer, 0);
 int32_t _14 = _halide_buffer_get_min(_blur_y_buffer, 1);
 int32_t _15 = _halide_buffer_get_extent(_blur_y_buffer, 1);
 int32_t _16 = _halide_buffer_get_stride(_blur_y_buffer, 1);
 ...
 bool _26 = _halide_buffer_is_bounds_query(_input_buffer);
 bool _27 = !(_26);
 bool _28 = 0 <= _11;
 int32_t _29 = _12 + _11;
 bool _30 = _29 <= 646;
 ...
 if (!_32)  {
  int32_t _33 = _12 + _11;
  int32_t _34 = _33 + 1;
  int32_t _35 = halide_error_constraints_make_required_region_smaller(_ucon, "Input buffer input", 0, 0, 647, _11, _34);
  return _35;
 }
 bool _36 = _halide_buffer_is_bounds_query(_input_buffer);
 bool _37 = !(_36);
 bool _38 = 0 <= _14;
 int32_t _39 = _15 + _14;
 bool _40 = _39 <= 480;
 ...
 if (!_42)  {
  int32_t _43 = _15 + _14;
  int32_t _44 = _43 + 1;
  int32_t _45 = halide_error_constraints_make_required_region_smaller(_ucon, "Input buffer input", 1, 0, 481, _14, _44);
  return _45;
 }
 bool _46 = _halide_buffer_is_bounds_query(_blur_y_buffer);
 if (_46)
 {
  struct halide_dimension_t *_47 = _halide_buffer_get_shape(_blur_y_buffer);
  uint64_t _48 = (uint64_t)(0);
  void *_49 = (void *)(_48);
  ...
  struct halide_dimension_t *_51 = (struct halide_dimension_t *)(&s0);
  struct halide_buffer_t *_52 = _halide_buffer_init(_blur_y_buffer, _47, _49, _48, _50, 1, 16, 2, _51, _48);
  (void)_52;
 } // if _46
 bool _53 = _halide_buffer_is_bounds_query(_input_buffer);
 if (_53)
 {
  struct halide_dimension_t *_54 = _halide_buffer_get_shape(_input_buffer);
  uint64_t _55 = (uint64_t)(0);
  void *_56 = (void *)(_55);
  ...
  struct halide_dimension_t *_58 = (struct halide_dimension_t *)(&s1);
  struct halide_buffer_t *_59 = _halide_buffer_init(_input_buffer, _54, _56, _55, _57, 1, 16, 2, _58, _55);
  (void)_59;
 } // if _53
 bool _60 = _halide_buffer_is_bounds_query(_blur_y_buffer);
 bool _61 = _halide_buffer_is_bounds_query(_input_buffer);
 bool _62 = _60 || _61;
 bool _63 = !(_62);
 if (_63)
 {
  uint32_t _64 = (uint32_t)(69633);
  bool _65 = _9 == _64;
  if (!_65)   {
   uint32_t _66 = (uint32_t)(69633);
   int32_t _67 = halide_error_bad_type(_ucon, "Output buffer blur_y", _9, _66);
   return _67;
  }
  bool _68 = _10 == 2;
  if (!_68)   {
   int32_t _69 = halide_error_bad_dimensions(_ucon, "Output buffer blur_y", _10, 2);
   return _69;
  }
  uint32_t _70 = (uint32_t)(69633);
  bool _71 = _18 == _70;
  if (!_71)   {
   uint32_t _72 = (uint32_t)(69633);
   int32_t _73 = halide_error_bad_type(_ucon, "Input buffer input", _18, _72);
   return _73;
  }
  bool _74 = _19 == 2;
  if (!_74)   {
   int32_t _75 = halide_error_bad_dimensions(_ucon, "Input buffer input", _19, 2);
   return _75;
  }
  bool _76 = 0 <= _12;
  if (!_76)   {
   int32_t _77 = halide_error_buffer_extents_negative(_ucon, "Output buffer blur_y", 0, _12);
   return _77;
  }
  bool _78 = 0 <= _15;
  if (!_78)   {
   int32_t _79 = halide_error_buffer_extents_negative(_ucon, "Output buffer blur_y", 1, _15);
   return _79;
  }
  bool _80 = _20 <= _11;
  int32_t _81 = _12 + _11;
  ...
  if (!_85)   {
   ...
   int32_t _88 = _21 + _20;
   int32_t _89 = _88 + -1;
   int32_t _90 = halide_error_access_out_of_bounds(_ucon, "Input buffer input", 0, _11, _87, _20, _89);
   return _90;
  }
  bool _91 = 0 <= _21;
  if (!_91)   {
   int32_t _92 = halide_error_buffer_extents_negative(_ucon, "Input buffer input", 0, _21);
   return _92;
  }
  bool _93 = _23 <= _14;
  int32_t _94 = _15 + _14;
  ...
  if (!_98)   {
   int32_t _99 = _15 + _14;
   int32_t _100 = _99 + 1;
   int32_t _101 = _24 + _23;
   int32_t _102 = _101 + -1;
   int32_t _103 = halide_error_access_out_of_bounds(_ucon, "Input buffer input", 1, _14, _100, _23, _102);
   return _103;
  }
  bool _104 = 0 <= _24;
  if (!_104)   {
   int32_t _105 = halide_error_buffer_extents_negative(_ucon, "Input buffer input", 1, _24);
   return _105;
  }
  bool _106 = _13 == 1;
  if (!_106)   {
   int32_t _107 = halide_error_constraint_violated(_ucon, "blur_y.stride.0", _13, "1", 1);
   return _107;
  }
  bool _108 = _22 == 1;
  if (!_108)   {
   int32_t _109 = halide_error_constraint_violated(_ucon, "input.stride.0", _22, "1", 1);
   return _109;
  }
  bool _110 = _20 == 0;
  if (!_110)   {
   int32_t _111 = halide_error_constraint_violated(_ucon, "input.min.0", _20, "0", 0);
   return _111;
  }
  bool _112 = _21 == 648;
  if (!_112)   {
   int32_t _113 = halide_error_constraint_violated(_ucon, "input.extent.0", _21, "648", 648);
   return _113;
  }
  bool _114 = _25 == 648;
  if (!_114)   {
   int32_t _115 = halide_error_constraint_violated(_ucon, "input.stride.1", _25, "648", 648);
   return _115;
  }
  bool _116 = _23 == 0;
  if (!_116)   {
   int32_t _117 = halide_error_constraint_violated(_ucon, "input.min.1", _23, "0", 0);
   return _117;
  }
  bool _118 = _24 == 482;
  if (!_118)   {
   int32_t _119 = halide_error_constraint_violated(_ucon, "input.extent.1", _24, "482", 482);
   return _119;
  }
  int64_t _120 = (int64_t)(_15);
  int64_t _121 = (int64_t)(_12);
  int64_t _122 = _120 * _121;
  int64_t _123 = (int64_t)(0);
  int64_t _124 = _123 - _121;
  bool _125 = _121 > _123;
  int64_t _126 = (int64_t)(_125 ? _121 : _124);
  uint64_t _127 = (uint64_t)(_126);
  uint64_t _128 = _127;
  uint64_t _129 = (uint64_t)(2147483647);
  bool _130 = _128 <= _129;
  if (!_130)   {
   int64_t _131 = (int64_t)(_12);
   ...
   int32_t _139 = halide_error_buffer_allocation_too_large(_ucon, "blur_y", _137, _138);
   return _139;
  }
  int64_t _140 = (int64_t)(_15);
  int64_t _141 = (int64_t)(_16);
  ...
  bool _150 = _148 <= _149;
  if (!_150)   {
   int64_t _151 = (int64_t)(_15);
   int64_t _152 = (int64_t)(_16);
   ...
   int32_t _161 = halide_error_buffer_allocation_too_large(_ucon, "blur_y", _159, _160);
   return _161;
  }
  int64_t _162 = (int64_t)(2147483647);
  bool _163 = _122 <= _162;
  if (!_163)   {
   int64_t _164 = (int64_t)(2147483647);
   int32_t _165 = halide_error_buffer_extents_too_large(_ucon, "blur_y", _122, _164);
   return _165;
  }
  uint64_t _166 = (uint64_t)(0);
  void *_167 = (void *)(_166);
  bool _168 = _blur_y != _167;
  if (!_168)   {
   int32_t _169 = halide_error_host_is_null(_ucon, "Output buffer blur_y");
   return _169;
  }
  uint64_t _170 = (uint64_t)(0);
  void *_171 = (void *)(_170);
  bool _172 = _input != _171;
  if (!_172)   {
   int32_t _173 = halide_error_host_is_null(_ucon, "Input buffer input");
   return _173;
  }
  // produce blur_y
  for (int _blur_y_s0_y = _14; _blur_y_s0_y < _14 + _15; _blur_y_s0_y++)
  {
   for (int _blur_y_s0_x = _11; _blur_y_s0_x < _11 + _12; _blur_y_s0_x++)
   {
    int32_t _174 = _blur_y_s0_y * 648;
    int32_t _175 = _174 + _blur_y_s0_x;
    int32_t _176 = _175 + 1298;
    uint16_t _177 = ((const uint16_t *)_input)[_176];
    int32_t _178 = _175 + 1296;
    uint16_t _179 = ((const uint16_t *)_input)[_178];
    int32_t _180 = _175 + 1297;
    uint16_t _181 = ((const uint16_t *)_input)[_180];
    uint16_t _182 = _179 + _181;
    uint16_t _183 = _177 + _182;
    uint16_t _184 = (uint16_t)(3);
    uint16_t _185 = _183 / _184;
    int32_t _186 = _175 + 2;
    uint16_t _187 = ((const uint16_t *)_input)[_186];
    uint16_t _188 = ((const uint16_t *)_input)[_175];
    int32_t _189 = _175 + 1;
    uint16_t _190 = ((const uint16_t *)_input)[_189];
    uint16_t _191 = _188 + _190;
    uint16_t _192 = _187 + _191;
    uint16_t _193 = _192 / _184;
    int32_t _194 = _175 + 650;
    uint16_t _195 = ((const uint16_t *)_input)[_194];
    int32_t _196 = _175 + 648;
    uint16_t _197 = ((const uint16_t *)_input)[_196];
    int32_t _198 = _175 + 649;
    uint16_t _199 = ((const uint16_t *)_input)[_198];
    uint16_t _200 = _197 + _199;
    uint16_t _201 = _195 + _200;
    uint16_t _202 = _201 / _184;
    uint16_t _203 = _193 + _202;
    uint16_t _204 = _185 + _203;
    uint16_t _205 = _204 / _184;
    int32_t _206 = _blur_y_s0_y * _16;
    int32_t _207 = _206 + _blur_y_s0_x;
    int32_t _208 = _14 * _16;
    int32_t _209 = _208 + _11;
    int32_t _210 = _207 - _209;
    ((uint16_t *)_blur_y)[_210] = _205;
   } // for _blur_y_s0_x
  } // for _blur_y_s0_y
 } // if _63
 return 0;
