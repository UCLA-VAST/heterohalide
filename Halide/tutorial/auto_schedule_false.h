...
int auto_schedule_false(struct halide_buffer_t *_input_buffer, float _factor, struct halide_buffer_t *_output1_buffer, struct halide_buffer_t *_output2_buffer) HALIDE_FUNCTION_ATTRS;
