...
int auto_schedule_true(struct halide_buffer_t *_input_buffer, float _factor, struct halide_buffer_t *_output1_buffer, struct halide_buffer_t *_output2_buffer) HALIDE_FUNCTION_ATTRS;
int auto_schedule_true_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *auto_schedule_true_metadata() HALIDE_FUNCTION_ATTRS;
