...
struct Outputs {
    ...
    /** The name of the emitted Heterocl file. Empty if no HeteroCL file
     * output is desired  */
    std::string heterocl_name;
    ...
    Outputs heterocl(const std::string &heterocl_name) const {
        Outputs updated = *this;
        updated.heterocl_name = heterocl_name;
        return updated;
    }
