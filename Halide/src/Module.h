...
public:
    ...
    * exists in this module, assert. */
    ...
    void compile(const Outputs &output_files_arg, const std::vector<Internal::Function> &output_funcs = std::vector<Internal::Function> {}, const std::vector<int> &output_shape = std::vector<int> {}) const;
