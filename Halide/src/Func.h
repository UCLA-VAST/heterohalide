...
class Stage {
    ...
    void set_dim_unroll_hcl(Var var, Internal::ForType t, int factor);
...
public:
    ...
    Stage &unroll_hcl(Var var, int factor);
...
public:
    ...
    /** compile to HeteroCL source code */
    void compile_to_heterocl(const std::string &filename,
                      const std::vector<Argument> &,
    ...
    */
    ...
    /** HeteroCL version of unroll. Just give a annotation and factor, do not use split */
    Func &unroll_hcl(Var var, int factor);
